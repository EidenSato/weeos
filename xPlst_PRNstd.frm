...
Dim Pdata_tainetsu() As String  '*** Pdata_tainetsu(FLGtuzuki) ***
...
'
    NowpointX = kijunX + haba1X + haba2X + haba3X + haba31X + haba4X + haba5X
    NowpointY = kijunY + gyoukan * FLGgyou
    Printer.Line (NowpointX, NowpointY)-Step(haba5X, gyoukan), 0, B
'
    NowpointX = kijunX + haba1X + haba2X + haba3X + haba31X + haba4X + haba5X * 2
    NowpointY = kijunY + gyoukan * FLGgyou
    Printer.Line (NowpointX, NowpointY)-Step(haba5X, gyoukan), 0, B
'
    NowpointX = kijunX + haba1X + haba2X + haba3X + haba31X + haba4X + haba5X * 3
    NowpointY = kijunY + gyoukan * FLGgyou
    Printer.Line (NowpointX, NowpointY)-Step(haba6X, gyoukan), 0, B
'
    NowpointX = kijunX + haba1X + haba2X + haba3X + haba31X + haba4X + haba5X * 3 + haba6X
    NowpointY = kijunY + gyoukan * FLGgyou
'    Printer.Line (NowpointX, NowpointY)-Step(haba6X, gyoukan), 0, B
'
'    NowpointX = kijunX + haba1X + haba2X + haba3X + haba4X + haba5X * 3 + haba6X * 2
'    NowpointY = kijunY + gyoukan * FLGgyou
...
'
    If Pdata_ghyouji(FLGtuzukip) <> "" Then
        ...
        Printer.Line (NowpointX, NowpointY)-Step(haba31X, gyoukan), 0, B
'
        If 25 < LenMbcs(Pdata_kikaku(FLGtuzukip)) Then
            tempStrA = Left(Pdata_ghyouji(FLGtuzukip), 28)
            tempStrB = Mid(Pdata_ghyouji(FLGtuzukip), 29)
'
            Printer.CurrentX = NowpointX + moji_zureX
...
'
        ...
        ElseIf 21 < LenMbcs(Pdata_kikaku(FLGtuzukip)) Then
            Printer.CurrentX = NowpointX + moji_zureX
            Printer.CurrentY = NowpointY + moji_zureY
'
            Call SETfont_size(9, 1)    '*** フォントサイズ設定 ***
...
'
    ...
    If Pdata_kosuu(FLGtuzukip) <> "" Then
        Printer.CurrentX = NowpointX + moji_zureX
        Printer.CurrentY = NowpointY + moji_zureY
            SET_migiyose Pdata_kosuu(FLGtuzukip), Pdata, 6  '*** 6文字にする
        Printer.Print Pdata
    End If
'
    NowpointX = kijunX + haba1X + haba2X + haba3X + haba31X + haba4X + haba5X
    ...
    If Pdata_sousuu(FLGtuzukip) <> "" Then
        Printer.CurrentX = NowpointX + moji_zureX
        Printer.CurrentY = NowpointY + moji_zureY
            SET_migiyose Pdata_sousuu(FLGtuzukip), Pdata, 6 '*** 6文字にする
        Printer.Print Pdata
    End If
'
    NowpointX = kijunX + haba1X + haba2X + haba3X + haba31X + haba4X + haba5X * 2
    ...
    If Pdata_maker(FLGtuzukip) <> "" Then
        Printer.CurrentX = NowpointX + moji_zureX
        Printer.CurrentY = NowpointY + moji_zureY
            SET_tyuuou Trim(Pdata_maker(FLGtuzukip)), Pdata, 6  '*** 6文字にする
        Printer.Print Pdata
    End If
'
    NowpointX = kijunX + haba1X + haba2X + haba3X + haba31X + haba4X + haba5X * 3
    ...
    If Pdata_RoHS(FLGtuzukip) <> "" Then
        Printer.CurrentX = NowpointX + moji_zureX - 70
        Printer.CurrentY = NowpointY + moji_zureY
...
'
    ...
    ElseIf optTainetu.Value = True Then
        Printer.CurrentX = NowpointX + moji_zureX
        Printer.CurrentY = NowpointY + moji_zureY
        Printer.Print Pdata_tainetsu(FLGtuzukip)
    End If
End Sub
...
'
    ...
    NowpointY = kijunY + gyoukan * FLGgyou
    Printer.Line (NowpointX, NowpointY)-Step(haba31X, gyoukan), 0, B
    Printer.CurrentX = NowpointX + 678 + moji_zureX     '212
    Printer.CurrentY = NowpointY + moji_zureY
    Printer.Print "現品表示"
'
    haba4X = 1844       '2776
...
'
    ...
    Else
'        Printer.CurrentX = NowpointX + 793 + moji_zureX
        Printer.CurrentX = NowpointX + moji_zureX
        Printer.CurrentY = NowpointY + moji_zureY
        Printer.Print "MSL/   備 考"
    End If
End Sub
...
'
    ...
    Printer.CurrentX = NowpointX + moji_zureX
    Printer.CurrentY = NowpointY + moji_zureY
        Call SET_migiyose("1", Pdata, 6)   '*** 6文字にする
    Printer.Print Pdata
'
    NowpointX = kijunX + haba1X + haba2X + haba3X + haba31X + haba4X + haba5X
    NowpointY = kijunY + gyoukan * FLGgyou
    ...
    Printer.CurrentX = NowpointX + moji_zureX
    Printer.CurrentY = NowpointY + moji_zureY
        Call SET_migiyose(str(Val(BaisuuT) * Val(DaisuuT)), Pdata, 6)  '*** 6文字にする
    Printer.Print Pdata
'
    NowpointX = kijunX + haba1X + haba2X + haba3X + haba31X + haba4X + haba5X * 2
    NowpointY = kijunY + gyoukan * FLGgyou
...
'
                                    ...
                                    End If
'
                                    If InStr(CmainT(kpT, 19), "SnPb") <> 0 Then
                                        Tmp1 = Tmp1 & "----"
...
'
                                    If optBikou.Value = True Then
                                        ...
                                        Pdata_bikou(FLGtuzuki) = TMPmoji & "," & Pdata_bikoup
                                    ElseIf optTanka.Value = True Then
                                        Pdata_tanka(FLGtuzuki) = Val(CmainT(kpT, 5))
                                    ElseIf optTainetu.Value = True Then
                                        Tmp1 = CmainT(kpT, 11)
                                        If Len(Tmp1) < 3 Then Tmp1 = "   "
                                        Tmp1 = Tmp1 & "℃,"
'
'                                        If Pdata_bikoup = "*" Then
'                                            Pdata_bikoup = " "
'                                        End If
                                        Pdata_tainetsu(FLGtuzuki) = Tmp1 & Pdata_bikoup
                                    End If
'
...
'
                            ...
                            BuhinBangouMojisuu = 15 + 37 - 2    '***印刷ルーチンで使用
'
...
'
                                    For j = Ckdim - 1 To i + 1 Step -1      '*** 全体をずらす
                                        ...
                                        Pdata_tainetsu(j + 1) = Pdata_tainetsu(j)
