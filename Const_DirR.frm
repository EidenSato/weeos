...
'
    ...
    Else
        ...
        If FLGshinki = 0 And Tmp1 = "" Then
            i = MsgBox("ファイル " & DRVconstT & " が見つかりません｡ ", vbCritical, STATUS)
            Exit Sub
'
        End If
'
        If FLGshinki = 0 Then
            ...
            DoEvents
            Call RDconst_lst(DRVconstT, CATnoT, CATnameT, ZubanT, PersonT, OrgdateT, RevdateT _
...
'
    cmd_New.Top = 480 + (3600 - 480) * HyoujiBairitu
    cmd_New.Left = 480 + (4320 - 480) * HyoujiBairitu
