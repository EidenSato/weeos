...
Private Sub mnufileNW_Click()
    Call Copy_plst_work2temp
'
    Plst_DirW.Show 1    '*** 部品表/作成データ書き込み ***
'
    If FLGesc = 0 Then
        DRVpartlist = DRVpartlistT
        PFLname = PFLnameT
