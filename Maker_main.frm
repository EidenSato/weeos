...
'
    ...
    Private Const pichi3 = c10mm * 10.8
    Private Const pichi4 = c10mm * 12.35
    Private Const pichi5 = c10mm * 14#
    Private Const pichi6 = c10mm * 16#

Private Sub Form_Activate()
    FLGmaker = 1     '*** メーカー画面存在フラグ設定 ***
'
...
'                   グリッド幅の設定
    ...
    MSFlexGrid1.Cols = 7
    MSFlexGrid1.ColWidth(0) = 480 * HyoujiBairitu
    MSFlexGrid1.ColWidth(1) = 840 * HyoujiBairitu
    MSFlexGrid1.ColWidth(2) = 4235 * HyoujiBairitu + (300 * HyoujiBairitu - 300) + FLGoffsetX
    MSFlexGrid1.ColWidth(3) = 840 * HyoujiBairitu
    MSFlexGrid1.ColWidth(4) = 840 * HyoujiBairitu
    MSFlexGrid1.ColWidth(5) = 840 * HyoujiBairitu
    MSFlexGrid1.ColWidth(6) = 960 * HyoujiBairitu
'
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Makp = 1        '*** フラグ初期化 ***
    Makps = 1       '***<再ロード時 "Form_Initialize"前に "MSFlexGrid1_Scroll" が発生してしまう予防>***
End Sub
...
'
    For i = 1 To Maknum0
        MSFlexGrid1.Row = i
        MSFlexGrid1.Col = 0
        MSFlexGrid1.Text = Maker(i, 0)
        MSFlexGrid1.Col = 1
        MSFlexGrid1.Text = Maker(i, 1)
        MSFlexGrid1.Col = 2
        MSFlexGrid1.Text = Maker(i, 2)
'
        MSFlexGrid1.Col = 3
        temp = Maker(i, 4)
            Call GETtrader2(temp)
...
'
        MSFlexGrid1.Col = 6
        MSFlexGrid1.Text = Maker(i, 7)
    Next i
'
    MSFlexGrid1.TopRow = Makp
    Text1.Text = Maker(Makps, 1)
End Sub
...
'
    ...
    ElseIf Maknum0 > j + 19 Then
        MSFlexGrid1.TopRow = j + 1
    Else
        Beep
        MSFlexGrid1.TopRow = Maknum0 - 18
    End If
'
    Makp = MSFlexGrid1.TopRow
    Makps = Makp
    Text1.Text = Maker(Makps, 1)
End Sub
...
'                       '*** モーダルフォーム実行後、続いて実行される。***
    If FLGmak_data_change = 1 Then   '*** 変更有り ***
        Call DATA_settei
        FLGmak_data_change = 0   '*** 変更フラグ初期化 ***
    End If
'
...
Private Sub MSFlexGrid1_Click()
    If MSFlexGrid1.Row <= Maknum0 Then
        Makps = MSFlexGrid1.Row
        Text1.Text = Maker(Makps, 1)
    End If
'
    Text1.SetFocus
...
Private Sub mnuFilePrn_Click()  '*** メーカー 一覧印刷 ***
...
Private Sub mnuFileWR_Click()   '*** メーカー 一覧ファイル出力 ***
    Dim CSVfile As String, PDa As String, PD As String, makername As String
...
'
    ...
    End With
'
    Maker_main.MousePointer = vbHourglass
    MSFlexGrid1.MousePointer = flexHourglass
...
'
    ...
    For Makp = 1 To Maknum0
        DoEvents    '*** 砂時計用 ***
'
        PDa = Chr(34) & Maker(Makp, 0) & Chr(34) & "," _
            & Chr(34) & Maker(Makp, 1) & Chr(34) & "," _
            & Chr(34) & Maker(Makp, 2) & Chr(34) & ","
'
        PD = Maker(Makp, 4)
        Call GETtrader2(PD)
...
'
        ...
        PDa = PDa & Chr(34) & PD & Chr(34) & ","
'
        PDa = PDa & Chr(34) & Maker(Makp, 7) & Chr(34)
'
        Print #FILE_number, PDa  '*** データ書き込み ***
    Next Makp
    Close #FILE_number
    Maker_main.MousePointer = vbDefault
    MSFlexGrid1.MousePointer = flexArrow
'
error_F:
    Maker_main.Caption = HeadTitle
End Sub
...
'
    ...
    Printer.Print "===  [  営電標準  ]               電気部品コード・単価表                ＜メーカー 一覧表＞  ==="
'
    Printer.CurrentX = kijunX + moji_zureX
    Printer.CurrentY = kijunY + gyoukan + moji_zureY
    SETfont_size 9, 1      '*** フォント,サイズ設定 ***
    Printer.Print "ｺｰﾄﾞ    略称                 メーカー名                             買先-Ａ   買先-Ｂ   買先-Ｃ      更新日"
'
    Printer.DrawWidth = 6
...
'
    Text1.Left = 360 + (3840 - 360) * HyoujiBairitu + FLGoffsetX
...
'
    Label1.Left = 360 + (2520 - 360) * HyoujiBairitu + FLGoffsetX
    Label1.Top = 360 + (5760 - 360) * HyoujiBairitu + FLGoffsetY
    Label1.FontSize = 10 * HyoujiBairitu
    Label1.Width = 1335 * HyoujiBairitu
...
'
    ...
    cmdClose.FontSize = 10 * HyoujiBairitu
    cmdClose.Width = 975 * HyoujiBairitu
...
'
    ...
    cmdPage.FontSize = 10 * HyoujiBairitu
    cmdPage.Width = 1215 * HyoujiBairitu
...
'
    If Eeos2_mainMDI.ScaleWidth > Width Then
        Left = (Eeos2_mainMDI.ScaleWidth - Width) \ 3
    Else
        Left = 0
    End If
End Sub
